...
public class MyService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                ...
                noti = sharedPreferences.getString("noti", "0");

                if(!model.equals("")) {
                    gValue = new GetValue();
                    gValue.execute(getValueURL, model, noti);
                }
    ...
    private NotificationCompat.Builder getNotificationBuilder(String model) {
    ...
    public void sendNotification(String model) {
        NotificationCompat.Builder builder = getNotificationBuilder(model);
