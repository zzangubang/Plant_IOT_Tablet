...
public class TempData extends Fragment {
    ...
    TextView avgTemp, minTemp, maxTemp;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        avgTemp = (TextView) v.findViewById(R.id.avgTemp);
        ...
        protected void onPostExecute(String str) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if(i == 0) {
                        minTempT = maxTempT = Double.valueOf(value);
                        avgTempT += Double.valueOf(value);
                        tempCnt++;
                    }
                    if(minTempT >= Double.valueOf(value)) {
                        minTempT = Double.valueOf(value);
                    }
                    if(maxTempT <= Double.valueOf(value)) {
                        maxTempT = Double.valueOf(value);
                    }
                    avgTempT += Double.valueOf(value);
                    tempCnt++;
                ...
                avgTempT = avgTempT / tempCnt;
                avgTemp.setText(String.format("%.2f", avgTempT) + "°C");
                minTemp.setText(String.format("%.2f", minTempT) + "°C");
                maxTemp.setText(String.format("%.2f", maxTempT) + "°C");
                dialog.dismiss();
